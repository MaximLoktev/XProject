...
internal protocol CreatePostViewDelegate: class {
...
internal class CreatePostView: UIView, UITextViewDelegate, UITextFieldDelegate {
    ...
    private let collectionView = CreatePostCollectionView()
    ...
    override init(frame: CGRect) {
        ...
        containerView.addSubview(createPostButton)
        createPostButton.addTarget(self, action: #selector(createPostButtonAction(_:)), for: .touchUpInside)
    ...
    func setupLoad(viewModel: CreatePostDataFlow.Load.ViewModel) {
    }
    ...
    func setupNameError(isErrorShow: Bool, isValidData: Bool, typeError: CreatePostDataFlow.TypeError) {
        switch typeError {
        case .title:
        ...
        setupCreatePostButton(isEnabled: isValidData)
        delegate?.setupSaveBarButtonItem(isEnabled: isValidData)
    }
    
    func setupCreatePostButton(isEnabled: Bool) {
    ...
    @objc
    private func createPostButtonAction(_ sender: UIButton) {
